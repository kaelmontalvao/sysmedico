    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <select id="doctor_id" name="doctor_id" class="form-control placeholder" disabled>
        ...
        <div class="form-group row">
            <div class="mb-12 p-xl-3">
                ...
                <textarea class="form-control" id="observation" name="observation" cols="150px" readonly>{{ $schedule->observation }}</textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
