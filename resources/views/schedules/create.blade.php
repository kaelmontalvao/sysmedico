        ...
        <form method="POST" action="{{ route('schedule-store') }}">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select id="patient_id" name="patient_id" class="form-control placeholder" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input id="hours" type="time" class="form-control @error('hours') is-invalid @enderror" name="hours" value="{{ old('hours') }}" required autocomplete="hours">
            ...
            <div class="form-group row">
                <div class="mb-12 p-xl-3">
                    ...
                    <textarea class="form-control" id="observation" name="observation" cols="150px"></textarea>
                </div>
            </div>
            <div class="row">
